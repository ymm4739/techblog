<template>
      <div>
          ...
          <el-menu :default-active="activeIndex" mode="horizontal" background-color="black" text-color="white" active-text-color="yellow" router >
            ...
            <el-menu-item index="/login" v-if="!login" class="nav-login">登陆</el-menu-item>
            <el-submenu  v-if="login" class="nav-user">
